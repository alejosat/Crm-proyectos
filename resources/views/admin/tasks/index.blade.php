                            ...
                            @foreach ($tasks as $task)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admin.tasks.destroy', $task->id) }}" method="post" id="delete_form" onsubmit="return confirm('Esta seguro que desea eliminar el registro?')" style="display: inline-block;">
